...
export async function copyToClipboard(text: string): Promise<void> {
  ...
  if (typeof document !== 'undefined') {
    ...
    console.warn('[exportImport] Clipboard copy not fully supported in this environment without expo-clipboard');
  }
}
...
function triggerDownload(blob: Blob, fileName: string): void {
  if (typeof document === 'undefined' || typeof URL === 'undefined' || typeof URL.createObjectURL === 'undefined') {
    console.warn('[exportImport] triggerDownload not supported in this environment (likely React Native/Expo).');
    return;
  }
